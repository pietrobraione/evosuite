 ...
 * @author G. Denaro
 */
public class SeepepCoverageSuiteFitness extends TestSuiteFitnessFunction { /*SUSHI: Path condition fitness*/
	 ...
	 * 
	 */
	public SeepepCoverageSuiteFitness(List<SeepepCoverageGoalFitness> goals) throws IllegalArgumentException {
		if(goals == null){
	...
	public List<SeepepCoverageGoalFitness> getGoals() {
		return goals;
	}
	...
	public double getFitness(TestSuiteChromosome suite) {
		...
		TestFitnessFunction tf = SeepepCoverageFactory._I().getSeepepCoverageTestFitness();
		for (TestChromosome t : suite.getTestChromosomes()) {
			tf.getFitness(t);
		}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SeepepCoverageSuiteFitness other = (SeepepCoverageSuiteFitness) obj;
		if (goals == null) {
			if (other.goals != null)
				return false;
