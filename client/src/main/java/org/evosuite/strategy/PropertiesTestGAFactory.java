...
public class PropertiesTestGAFactory
	...
	private CrossOverFunction<TestChromosome> getCrossoverFunction(GeneticAlgorithm<TestChromosome> ga) {
	...
	public GeneticAlgorithm<TestChromosome> getSearchAlgorithm() {
		...
		// How to cross over
		CrossOverFunction<TestChromosome> crossover_function = getCrossoverFunction(ga /*SUSHI Crossover*/);
