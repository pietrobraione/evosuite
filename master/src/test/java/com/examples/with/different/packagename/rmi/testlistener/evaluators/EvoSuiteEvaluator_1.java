...
public class EvoSuiteEvaluator_1 {
    ...
    private void populateCalculators0(ArrayList<ValueCalculator> calculators) {
        calculators.add(new ValueCalculator() {
            ...
            double cdistance() {
                return (((int) ___INTERNAL__args__[0]) > 10000 ? 0.0 : 10000 - ((int) ___INTERNAL__args__[0]));
            }
        });
    }
    ...
    private void populateCalculators1(ArrayList<ValueCalculator> calculators) {
        calculators.add(new ValueCalculator() {
            ...
            boolean condition() {
                return (!(___INTERNAL__retVal_ instanceof Throwable)) && ((int) ___INTERNAL__retVal_) < 0;
            }

            double cdistance() {
                return (condition() ? 0.0 : ___INTERNAL__retVal_ instanceof Throwable ? BIG_DISTANCE - SMALL_DISTANCE : ((int) ___INTERNAL__retVal_)) - 0;
            }
        });
    }
	...
	public String toString() {
		return "custom description of EvoSuiteEvaluator_1 []";
	}
